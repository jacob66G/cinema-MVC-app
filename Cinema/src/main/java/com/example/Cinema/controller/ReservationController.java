...
public class ReservationController {
    ...
    @Autowired
    public ReservationController(ReservationService reservationService, ProgrammeService programmeService, TicketService ticketService, PriceListService priceListService) {
    ...
    public String getReservationPage(@PathVariable Long id, Model model) {
        ...
        if (programme.isPresent()) {
            ...
            for (int i = 0; i < numberOfRows; i++) {
                ...
                rows.add(String.valueOf(character));
            }
    ...
    public String completeReservation(
        ...
        for(Ticket ticket : ticketList){
            ...
            ticket.setPrice(priceListService.getTicketPrice(ticketType, programmeDate));
